...
class CConsoleVaraible final : public IEntityComponent // Best practice: Classes start with a 'C'
...
public:
	...
	static void ReflectType(Schematyc::CTypeDesc<CConsoleVaraible>& desc)
	{
		...
		desc.SetLabel("Console Variable");
	}
