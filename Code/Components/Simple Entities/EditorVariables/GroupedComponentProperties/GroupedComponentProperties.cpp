...
#include "Components/Simple Entities/EditorVariables/GroupedComponentProperties/GroupedComponentProperties.h"
...
Cry::Entity::EventFlags CGroupedComponentProperties::GetEventMask() const
{
	return
...
void CGroupedComponentProperties::ProcessEvent(const SEntityEvent& event)
{
	switch (event.event)
	{
